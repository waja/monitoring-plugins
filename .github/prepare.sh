...
[ -d /srv/www/htdocs ] && touch /srv/www/htdocs/index.html
[ -d /var/www/html ] && touch /var/www/html/index.html
...
case "$distro_id" in
    ...
    *)
	...
	echo -e "[mysql]\nsocket=/var/lib/mysql/mysql.sock" >> /etc/my.cnf.d/client.cnf
	# Fix socket on rhel
	...
	grep NP_MYSQL_SOCKET .github/NPTest.cache
	sleep 3
	;;
esac
